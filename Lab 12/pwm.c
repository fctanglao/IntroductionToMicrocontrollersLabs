 ...
 * Author: francis
 *
 * Created on July 31, 2024, 12:40 PM
 */
...
/*
 * Use the ADC to control the duty cycle of PWM signal
 * Use AN0 as your analog input pin for the ADC
 * Use CCP2 to generate the PWM signal
 * Isolate the DC motor from the microcontroller using either a transistor or optocoupler
 */
